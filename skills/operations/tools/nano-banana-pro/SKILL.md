...
description: "Generate or edit images with Gemini — use for image create/modify requests, text-to-image and image-to-image edits, 1K/2K/4K, use --input-image"
version: "1.0.1"
permissions:
  filesystem: write      # saves generated images to current working directory
  network: true          # calls generativelanguage.googleapis.com via google-genai SDK
triggers:
  - command: /nano-banana
