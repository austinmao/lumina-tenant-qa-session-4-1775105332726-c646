---
name: colorize
description: Use when add strategic color to features that are too monochromatic or
  lack visual interest, making interfaces more engaging and expressive. Use when the
  user mentions the design looking gray, dull, lacking warmth, needing more color,
  or wanting a more vibrant or expressive palette.
version: 1.0.0
permissions:
  filesystem: none
  network: false
