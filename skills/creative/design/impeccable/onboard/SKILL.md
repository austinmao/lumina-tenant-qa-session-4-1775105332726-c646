---
name: onboard
description: Use when designs and improves onboarding flows, empty states, and first-run
  experiences to help users reach value quickly. Use when the user mentions onboarding,
  first-time users, empty states, activation, getting started, or new user flows.
version: 1.0.0
permissions:
  filesystem: none
  network: false
