---
name: critique
description: Use when evaluate design from a UX perspective, assessing visual hierarchy,
  information architecture, emotional resonance, cognitive load, and overall quality
  with quantitative scoring, persona-based testing, and actionable feedback. Use when
  the user asks to review, critique, evaluate, or give feedback on a design or component.
version: 1.0.0
permissions:
  filesystem: none
  network: false
...
- **Suggested command**: Which command could address this (from: /adapt, /animate, /arrange, /audit, /bolder, /clarify, /colorize, /critique, /delight, /distill, /extract, /frontend-design, /harden, /normalize, /onboard, /optimize, /overdrive, /polish, /quieter, /teach-impeccable, /typeset)

### Persona Red Flags
> *Consult [personas](reference/personas.md)*

Auto-select 2–3 personas most relevant to this interface type (use the selection table in the reference). If `SOUL.md` contains a `## Design Context` section from `teach-impeccable`, also generate 1–2 project-specific personas from the audience/brand info.
...
- Only recommend commands from: /adapt, /animate, /arrange, /audit, /bolder, /clarify, /colorize, /critique, /delight, /distill, /extract, /frontend-design, /harden, /normalize, /onboard, /optimize, /overdrive, /polish, /quieter, /teach-impeccable, /typeset
